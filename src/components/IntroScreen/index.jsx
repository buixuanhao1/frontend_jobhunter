...
const IntroScreen = ({ onComplete }) => {
    ...
    const handleEnter = () => {
        if (!show) return;
        setShow(false);
        setTimeout(onComplete, 500); // Chờ animation biến mất mới báo hoàn thành
    };
    ...
    return (
        <motion.div
            ...
            style={{
                position: 'fixed',
                inset: 0,
                background: '#0a0a0f', // Màu nền tối kiểu SaaS
                zIndex: 9999,
                display: 'flex',
            ...
            onClick={handleEnter} // Cho phép click để bỏ qua nhanh
        >
            {/* Quầng sáng nền (Ambient Glow) */}
            <motion.div
            ...
            <div style={{ position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                ...
                <motion.div
                    ...
                    style={{
                        ...
                        boxShadow: '0 20px 40px rgba(22,119,255,0.4), inset 0 2px 4px rgba(255,255,255,0.3)',
                        marginBottom: 30,
                        position: 'relative',
                ...
                >
                    ...
                    />
                    {/* SVG Icon Logo - WorkHub (Search + Bag) */}
                    <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ position: 'relative', zIndex: 2 }}>
                        ...
                        <path d="m15 17 2 2" strokeWidth="1.5" />
                    </svg>
                </motion.div>

                {/* Tên thương hiệu hiệu ứng Reveal */}
                <div style={{ overflow: 'hidden' }}>
                    <motion.h1
                        ...
                        style={{
                            ...
                            letterSpacing: '-1.5px',
                            margin: 0,
                            background: 'linear-gradient(to right, #ffffff, #91caff)',
